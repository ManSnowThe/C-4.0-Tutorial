...
namespace ca2
{
    ...
    class VarianceDemo
    {
        static void Main()
        {
            ...
            Console.WriteLine("Имя объекта, на который ссылается переменная AlphaRef: " + AlphaRef.GetObject().GetName());
            ...
            Console.WriteLine("Имя объекта, на который теперь ссылается переменная AlphaRef: " + AlphaRef.GetObject().GetName());
